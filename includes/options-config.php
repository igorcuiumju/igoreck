...
<p class="wrap-header">
	...
	<a class="upgrade" href="http://www.webulousthemes.com/theme/modulus-pro/">
				...
				'sections' => array(
					'general' => array(
						...
						'fields' => array(
                            ...
                            'sidebar_position' => array(
                                'type' => 'radio',
                                'label' => __('Website Layout Options', 'modulus'),
                                ...
                                'choices' => array(
                                    ...
                                    'fullwidth' => __('Full Width', 'modulus'),
                                    'no-sidebar' => __('No Sidebar', 'modulus'),
                                ),
                                'default' => 'right',  
                            ),
						),
					...
					'home' => array(
						...
						'fields' => array(
							'slider_field' => array(   
								'type' => 'checkbox',
								'label' => __('Enable Home Page Slider Section', 'modulus'),
								'default' => 1,
								'sanitize_callback' => 'modulus_boolean',
							),
							'slider_cat' => array(
							...
							'flexcaption_bg' => array(   
								'type' => 'checkbox',
								'label' => __('Enable Flexcaption Background', 'modulus'),
								'default' => 1,
								'sanitize_callback' => 'modulus_boolean',
							),
							'slider_count' => array(
							...
							'enable_service' => array(
                                'type' => 'checkbox',
                                'label' => __('Enable Home Page Service Section', 'modulus'),
                                'description' => __('Enable service section in home page', 'modulus'),
                                'default' => 1,  
                            ), 	
							'service_1' => array(
								'type' => 'dropdown-pages',
							...
							'enable_recent_post_service' => array(
                                'type' => 'checkbox',
                                'label' => __('Enable Home Page Recent Post Section', 'modulus'),
                                'description' => __('Enable recent post section in home page', 'modulus'),
                                'default' => 1,  
                            ),
							...
							'enable_home_default_content' => array(
                                ...
                                'description' => __('Enable home page default content', 'modulus'),
                                'default' => 0,  
                            ),
							'page-builder' => array(
                                'type' => 'checkbox',
                                'label' => __('Use Page Builder: [ Option only available in Pro version ] Check this to disable theme options for home page content and use page builder to enter content', 'modulus'),
                                'description' => __(' Check to display breadcrumb navigation.', 'modulus'),
                                'default' => 0,  
                            ),
                            'flexslider' => array(
                                'type' => 'text',
                                'label' => __('Enter FlexSlider Shortcode ( FlexSlider for Home Page [  Option only available in Pro version ])', 'modulus'),
					...
					'blog' => array(
						...
						'description' => __('Blog Related Posts options', 'modulus'),
						'fields' => array(
